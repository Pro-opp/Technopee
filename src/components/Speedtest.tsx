...
export const Speedtest : React.FC = () => {
  ...
  <button onClick={()=>{test()}}>Check Speed</button>
        ...
        upload.isRunning == false && download.isRunning == false && upload.isComplete == true ?<div className="inset-0 flex items-center justify-center z-50 m-2">
          <div className="card">
                <div className="bg p-6 items-center justify-center"> 
                <p className="mb-1 text-4xl font-semibold text-gray-800 py-2 flex">{download.result.meanClientMbps ? ((download.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? (download.result.meanClientMbps).toFixed(2):(download.result.meanClientMbps * 1000).toFixed(0): ''}<p className='font-normal text-xl pt-3 px-1'>{download.result.meanClientMbps ? ((download.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? ' Mb/s' : ' kb/s': 'Kb/s'}</p></p>
                    <h3 className='mb-4 flex items-center'> <div className='w-4 mx-1'><ArrowDownCircleIcon color='FFBB70'/></div> Download</h3>
                <p className="mb-1 text-4xl font-semibold text-gray-800 py-2 flex">{upload.result.meanClientMbps ? ((upload.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? (upload.result.meanClientMbps).toFixed(2):(upload.result.meanClientMbps * 1000).toFixed(0): ''}<p className='font-normal text-xl pt-3 px-1'>{upload.result.meanClientMbps ? ((upload.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? ' Mb/s' : ' kb/s': 'Kb/s'}</p></p>
                <h3 className='mb-4 flex items-center'> <div className='w-4 mx-1'><ArrowUpCircleIcon color='FFBB70'/></div> Upload</h3>
                <button className="button pt-1" onClick={()=>{test()}}>
                    ...
                    <span className="lable">Check</span>
                </button> 
                </div>
                <div className="blob">
                </div>
        ...
        </div>: <div>
        {
            ...
            {
                upload.result.meanClientMbps ? ((upload.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? (upload.result.meanClientMbps).toFixed(2) + ' Mb/s' :(upload.result.meanClientMbps * 1000).toFixed(0) + ' kb/s': '0 Mb/s'
            }
        </h1>
        <h3 className='mb-4 flex items-center px-4'> <div className='w-4 mx-1'><ArrowUpCircleIcon color='FFBB70'/></div> Upload</h3>
        </div>
            ...
            <div className="card">
                ...
                <h1 className='text-6xl p-4'>
                {
                    download.result.meanClientMbps ? ((download.result.meanClientMbps * 1000).toFixed(0)).length > 3 ? (download.result.meanClientMbps).toFixed(2) + ' Mb/s':(download.result.meanClientMbps * 1000).toFixed(0) + ' kb/s': ''
                }
            </h1>
            <h3 className='mb-4 flex items-center px-4'> <div className='w-4 mx-1'><ArrowDownCircleIcon color='FFBB70'/></div> Download</h3>
                </div>
                <div className="blob"></div>
            </div>
